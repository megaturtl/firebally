...
# cooldown defined here
give @s carrot_on_a_stick[custom_data={firebally:1b},item_model="minecraft:fire_charge",custom_name={text:"firebally",color:"red",italic:false},use_cooldown={seconds:5.0f}]